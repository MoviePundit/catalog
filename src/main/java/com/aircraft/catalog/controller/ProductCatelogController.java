...
public class ProductCatelogController {
    ...
    value = {
      @ApiResponse(
        ...
        content = @Content(
          ...
          schema = @Schema(implementation = ProductCatelog.class)
        )
      )
    }
  )
  ...
  public ResponseEntity<List<ProductCatelog>> getAllProductsByCategory(
    ...
    return ResponseEntity.ok(
      productCatelogService.retrieveAllProductsByCategory(category)
    );
  }
  ...
  public ResponseEntity<ProductCatelog> createProduct(
    @Valid @RequestBody ProductCatelog product
  ) {
    ProductCatelog createdProduct = productCatelogService.createProduct(product);

    return ResponseEntity
      .created(URI.create(PRODUCT_URI + createdProduct.getProductId()))
      .body(createdProduct);
  }
  ...
  public ResponseEntity<ProductCatelog> updateProductCatelog(
    ...
    ProductCatelog updateProduct = productCatelogService.updateProduct(
      productId,
      product
    );
